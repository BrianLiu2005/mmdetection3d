...
from .kitti_data_utils import WaymoInfoGatherer, get_kitti_image_info_brian
...
def create_kitti_info_file(data_path,
    ...
    kitti_infos_train = get_kitti_image_info_brian(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    kitti_infos_val = get_kitti_image_info_brian(
        data_path,
        training=True,
        velodyne=True,
        calib=True,
    ...
    kitti_infos_test = get_kitti_image_info_brian(
        data_path,
        training=False,
        label_info=False,
        velodyne=True,
