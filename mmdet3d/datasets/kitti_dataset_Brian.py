...
class KittiBrianDataset(Custom3DDataset):
    r"""KITTI Dataset.
    ...
    def __init__(self,
                 ...
                 test_mode=False,
                 pcd_limit_range=[-80, -80, -3, 80, 80, 1.0],
                 **kwargs):
        super().__init__(
            data_root=data_root,
            ann_file=ann_file,
    ...
    def evaluate(self,
                 ...
                 submission_prefix=None,
                 show=False,
                 out_dir='data/kitti-brian/EvaluationResults',
                 pipeline=None):
    ...
    def convert_valid_bboxes(self, box_dict, info):
        ...
        minxy = torch.min(box_corners, dim=1)[0]
        maxxy = torch.max(box_corners, dim=1)[0]
